    ...
    <>
              ...
              <div key={group.name}>
                ...
                <ul className="mt-4 grid gap-4 sm:grid-cols-2">
                  {group.items.map((skill) => {
                    ...
                    return (
                      <Card as="li" key={skill.id} className="p-5">
      ...
      >
        <ol className="grid gap-6 sm:grid-cols-2">
          {profile.approach.map((step, index) => (
            <Card as="li" key={step.title} className="p-6">
      ...
      <Section id="about-labels" tone="raised">
        <div className="grid gap-6 lg:grid-cols-2">
          {settings.showEpistemicLegend && <EpistemicLegend headingLevel={2} id="about-legend" />}
