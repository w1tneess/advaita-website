...
export default function Footer() {
  ...
  return (
    <footer className="mt-auto border-t border-line/40 bg-canvas text-ink py-10 sm:py-12 lg:py-16">
      <Container>
        <div className="flex flex-col items-center text-center">
          ...
          {/* 2. Navigation Links */}
          <nav aria-label="Footer navigation" className="mt-6 sm:mt-8">
          ...
          {/* 4. Subtle Divider */}
          <div className="w-16 sm:w-20 border-t border-line/60 my-6 sm:my-8" aria-hidden="true" />
