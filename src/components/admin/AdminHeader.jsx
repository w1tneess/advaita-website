    ...
    <header className="sticky top-0 z-20 border-b border-line bg-canvas/80 backdrop-blur-xl">
      <div className="flex h-14 items-center gap-4 px-4 sm:px-6">
        <button
          ...
          className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-line bg-surface text-muted hover:text-ink lg:hidden shrink-0 transition-colors"
        >
        ...
        <div className="flex items-center min-w-[120px]">
          <p className="truncate text-sm font-semibold text-ink">{sectionLabel(pathname)}</p>
        </div>
        ...
        <div className="flex-1 max-w-xl mx-auto px-4 hidden sm:block">
          <button
            onClick={openSearch}
            className="flex w-full items-center justify-between gap-2 rounded-lg border border-line bg-surface px-3 py-1.5 text-sm text-muted transition-all hover:bg-raised hover:border-accent/40 hover:text-ink focus:outline-none focus:ring-2 focus:ring-accent"
          >
